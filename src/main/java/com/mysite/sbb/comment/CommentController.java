...
public class CommentController {
    ...
    public String createQuestionComment(@PathVariable("id")Integer id, @Valid CommentForm commentForm,
        ...
        Optional<Question> question=this.questionService.getOQuestion(id);
        Optional<SiteUser> siteUser=this.userService.getOUser(principal.getName());

        if(question.isPresent() && siteUser.isPresent()){
    ...
    public String deleteComment(Principal principal,@PathVariable("id")Integer id){
        ...
        if(comment.isPresent()){
            ...
            return String.format("redirect:/question/detail/%s",c.getQuestion());
